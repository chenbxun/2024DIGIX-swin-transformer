...
_C.DATA.DATA_PATH = 'data/dataset'
# Dataset name
...
# _C.MODEL.RESUME = './pretrained/ckpt_epoch_240.pth'
_C.MODEL.RESUME = './pretrained/swin_tiny_patch4_window7_224.pth'
...
_C.TRAIN.BASE_LR = 1e-04
_C.TRAIN.WARMUP_LR = 6.25e-08
_C.TRAIN.MIN_LR = 6.25e-07
# Clip gradient norm
...
_C.TRAIN.LR_SCHEDULER.NAME = 'reduce_on_plateau'  # 修改为 'reduce_on_plateau'
# 配置 reduce_on_plateau 的参数
_C.TRAIN.LR_SCHEDULER.REDUCE_ON_PLATEAU = CN()
_C.TRAIN.LR_SCHEDULER.REDUCE_ON_PLATEAU.PATIENCE = 25  # 骨干轮数
_C.TRAIN.LR_SCHEDULER.REDUCE_ON_PLATEAU.FACTOR = 0.7  # 学习率降低的因子
_C.TRAIN.LR_SCHEDULER.REDUCE_ON_PLATEAU.MIN_LR = 1e-6  # 学习率下限
# 如果不再使用 'cosine' 调度器，可以移除或注释掉相关参数
...
_C.OUTPUT = 'output/swin_tiny_patch4_window7_224/default'
